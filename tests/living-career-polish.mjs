...

{
  ...
  assert.equal(state.schemaVersion,16); assert.equal(state.gameVersion,"0.4.3.10.2");
...
// Existing schema-15 saves upgrade without regenerating the career.
{
  ...
  assert.equal(migrated.worldState.schemaVersion,16); assert.equal(migrated.worldState.gameVersion,"0.4.3.10.2");
