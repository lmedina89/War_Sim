...
for(const rankId of ["rank_army_e1","rank_army_e2","rank_army_e3","rank_army_e4","rank_army_e5","rank_army_e6","rank_army_e7","rank_army_e8","rank_army_o1","rank_army_o2","rank_army_o3"]){
...
assert.match(app,/rankMark\.append\(createRankInsignia\(/);
assert.doesNotMatch(app,/rankMark\.textContent=identity\.rank/);
assert.match(app,/formationView=assignment\.chain\.find\(item=>item\.formationInsigniaId\)/);
...
console.log("War Sim v0.4.3.2.2 rank-insignia and situation-patch QA passed");
