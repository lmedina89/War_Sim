...
assert.equal(sameA.gameVersion, "0.4.3");
...
// Existing schema-10 saves migrate forward without regenerating or moving the career.
{
  ...
  assert.equal(payload.worldState.gameVersion, "0.4.3");
...
console.log("War Sim v0.4.3 soldier and unit gameplay smoke test passed");
