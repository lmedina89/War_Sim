...
assert.equal(sameA.gameVersion, "0.4.1.6");
...
// Existing schema-10 saves migrate forward without regenerating or moving the career.
{
  ...
  assert.equal(payload.worldState.gameVersion, "0.4.1.6");
...
// v0.4.1.6 career-gameplay foundation: schedule, objectives, cooldowns, readiness, opportunities, deadlines, and billet authority.
{
  const seed = 410001;
...
// Schema-12 careers migrate into v0.4.1.6 without moving the player, and receive the new gameplay scaffolding.
{
  const seed = 410005;
...
console.log("War Sim v0.4.1.6 soldier and unit gameplay smoke test passed");
