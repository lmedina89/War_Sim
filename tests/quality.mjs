...
// v0.4.1.7 soldier/unit gameplay: scheduler, readiness, objectives, opportunities, conflicts, recovery, and authority definitions.
{
...
// Direct v0.4.0.3 schema-12 migration preserves the career and layers in v0.4.1.7 gameplay records.
{
  const seed = 404003;
  ...
  assert.equal(migrated.worldState.gameVersion, "0.4.1.7");
