...
// v0.4.1.4 soldier/unit gameplay: scheduler, readiness, objectives, opportunities, conflicts, recovery, and authority definitions.
{
...
// Direct v0.4.0.3 schema-12 migration preserves the career and layers in v0.4.1.4 gameplay records.
{
  const seed = 404003;
  ...
  assert.equal(migrated.worldState.gameVersion, "0.4.1.4");
...
// Current schema migration preserves v0.3.2.3 careers and adds skill profiles without regeneration.
{
  ...
  assert.equal(payload.worldState.gameVersion, "0.4.1.4");
