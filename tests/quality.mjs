...
// v0.4.1.6 soldier/unit gameplay: scheduler, readiness, objectives, opportunities, conflicts, recovery, and authority definitions.
{
...
// Direct v0.4.0.3 schema-12 migration preserves the career and layers in v0.4.1.6 gameplay records.
{
  const seed = 404003;
